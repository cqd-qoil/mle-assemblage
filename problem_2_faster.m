function [MTestResult, Assem] = problem_2_faster(bobData)
yalmip('clear');
...
EpsonX=2;%2/22/3/33 is Problem II/II'/III/III';

%--------------------------------%

sn=zeros(1,size(TrueAlpha,2));%the swapping probability for each n. This is new!
